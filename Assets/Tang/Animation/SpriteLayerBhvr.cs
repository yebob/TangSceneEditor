...
namespace Tang
{
  ...
  public class SpriteLayerBhvr : MonoBehaviour
  {
    ...
    public delegate void SpriteReady(TASprite sprite);
    ...
    private TASprite m_spritePrefab = null;
      ...
      set
	{
	  if( m_flipHorizontal != value )
		...
		{
		  sprite = child.GetComponent<TASprite>();
		  if( sprite != null )
    ...
    private IEnumerator OnSpriteAssetBundleChange()
    {
      ...
      AssetBundleRequest request = spriteAssetBundle.LoadAsync( spriteName, typeof(TASprite) );
      yield return request;
      
      spritePrefab = request.asset as TASprite;
	...
	{
	  // new instance
	  TASprite spriteInstance = Instantiate( spritePrefab ) as TASprite;
    ...
    private void OnSpriteReady(TASprite sprite)
    {
