...
#region Mono Methods
	...
	gameObject.name =  baseId + Tang.Config.NAME_SEP + id + Tang.Config.NAME_SEP + nickName;
      else
	gameObject.name =  baseId + Tang.Config.NAME_SEP + id + Tang.Config.NAME_SEP + Texts.ACTOR ;
