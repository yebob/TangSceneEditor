...
namespace TangScene
{
  ...
  public class SpriteAnimate : MonoBehaviour
  {
    ...
    ///   精灵资源准备好的回调
    /// </summary>
    public delegate void LateSpriteReady(TASprite sprite);
	...
	{
	  List<TASprite> spriteList = ComponentSelector.Filter<TASprite>(spriteAnimation.transform);
	  foreach( TASprite sprite in spriteList )
	    {
